...
async function getRecipes() {
  ...
  //            declared above
    // for( const recipeURLS of RECIPE_URLS) {
      ...
      try {
        ...
        const recipeURL = await fetch(currURL);
